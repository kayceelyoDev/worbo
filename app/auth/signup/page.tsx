    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm font-medium">Join the game. Guess the word.</p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 border-t border-slate-700">
                <p className="text-xs text-slate-400 text-center">
                  Join thousands of players. <span className="text-green-400 font-semibold">6 tries</span> to guess the word.
                </p>
              </div>
              <div className="text-center">
                <p className="text-slate-400 text-sm">
                  Already have an account?{' '}
                  <Link href="/auth/signin" className="text-green-400 hover:text-green-300 font-semibold transition">
                    Sign in here
                  </Link>
                </p>
              </div>
